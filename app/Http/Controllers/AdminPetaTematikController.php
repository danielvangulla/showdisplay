<?php namespace App\Http\Controllers;
	...
	class AdminPetaTematikController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Gambar Resolusi Rendah","name"=>"lores", "image"=> true];
			$this->col[] = ["label"=>"Gambar Resolusi Tinggi","name"=>"hires", "download"=> true];
			...
			$this->form[] = ['label'=>'Kategori Tematik','name'=>'kategoritematiks_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'kategoritematiks,kategori'];
			$this->form[] = ['label'=>'Jenis Tematik','name'=>'jenistematiks_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'jenistematiks,jenis'];
			$this->form[] = ['label'=>'Gambar Resolusi Rendah','name'=>'lores','type'=>'upload','validation'=>'image','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Gambar Resolusi Tinggi','name'=>'hires','type'=>'upload','validation'=>'required','width'=>'col-sm-10'];
